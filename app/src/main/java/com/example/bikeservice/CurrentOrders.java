...
public class CurrentOrders extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new UserCurrentOrders(), "Schedual");
        adapter.addFragment(new CurrentEmergency(), "Emergency");
    ...
    public void onBackPressed() {
        Intent i=new Intent(CurrentOrders.this,UserNavigation.class);
        startActivity(i);
        finish();
    }
}
