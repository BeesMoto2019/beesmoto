...
public class ActiveOrder extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new MechActiveOrders(), "Schedual");
        adapter.addFragment(new MechEmergencyActive(), "Emergency");
    ...
    public void onBackPressed() {
        Intent i=new Intent(ActiveOrder.this,NavigationDrawer.class);
        startActivity(i);
        finish();
    }
}
